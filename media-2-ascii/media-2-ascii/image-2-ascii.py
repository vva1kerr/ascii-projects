...
def image_to_ascii(image_path, root_path, file_name, save_to_file=True):
...
# Example usage
image_path = "/Users/walkerhutchinson/Downloads/IMG_7272.PNG"
...
# To save to file
image_to_ascii(image_path, root_path, file_name, save_to_file=False)
